...
# печатаем таблицу значений
print("Метод Эйлера:")
print("t\tx1\tx2")
for i in range(0, len(x_euler)):
    print("{:.2f}\t{:.4f}\t{:.4f}".format(i*h, x_euler[i, 0], x_euler[i, 1]))

# печатаем таблицу значений аналитического решения
